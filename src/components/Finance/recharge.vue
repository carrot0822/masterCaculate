      ...
      <div class="commonMode" style="width:100%;overflow: auto">
        ...
        <section class="tableBox" v-loading="tableLoading">
          ...
          >
            ...
            <el-table-column align="center" prop="fkCardNumber" label="读者卡号" min-width="180" :show-overflow-tooltip="true"></el-table-column>
            <el-table-column align="center" prop="fkReaderName" label="用户名"  :show-overflow-tooltip="true"></el-table-column>
            <el-table-column align="center" prop="momentum" label="金额">
              <template slot-scope="scope">
            ...
            <el-table-column align="center" prop="serialNumber" label="流水标号" min-width="200" :show-overflow-tooltip="true"></el-table-column>
