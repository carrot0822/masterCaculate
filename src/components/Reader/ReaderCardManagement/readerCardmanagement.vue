	...
	<div class="useradd reader-card">
		<el-container>
					...
					<section class="searchBox" style="display: flex;flex-direction: row;justify-content: space-between">
						...
						<el-form :inline="true" :model="searchForm" class="demo-form-inline">
							<el-form-item label="筛选 :">
								<el-select style="width: 150px" v-model="searchForm.makeMethod" placeholder="请选择" clearable @change="selectCheck(searchForm.makeMethod)">
								...
								<el-select clearable id="gradeName" v-model="searchForm.type" style="width: 250px;display: none" placeholder="请选择等级名称">
									<el-option v-for="(option,index) of optionsDataType" :key="index" :label="option.name" :value="option.code"></el-option>
								</el-select>
							</el-form-item>
							<el-form-item label="状态:">
								<el-select clearable v-model="searchForm.state" style="width: 200px" placeholder="请选择状态">
									<el-option v-for="(option,index) of optionsData" :key="index" :label="option.name" :value="option.code"></el-option>
								</el-select>
							</el-form-item>
                ...
                <el-select clearable v-model="searchForm.state" style="width: 200px" placeholder="请选择状态">
                  ...
                  ></el-option>
					...
					<section class="tablebox" v-loading="tableLoading">
						<el-table @selection-change="selectAllBtn" :data="tableData" style="width: 100%; text-align:center;" :row-style="rowStyle"
						 :header-cell-style="{background:'#0096FF', color:'#fff',height:'60px'}">
							...
							<el-table-column align="center" prop="filterState" label="状态" width="150">
						...
						<section class="pagination mt_30">
							<el-pagination style="display: inline-block" background layout="prev, pager, next,total,slot" :total="total"
							 :page-size="pageSize" :current-page="currentPage" @current-change="current_change">
								<slot>
									<span>
										前往
					...
					<div class="formBox" style="width:360px">
						<el-form :model="logOut">
							...
							<el-form-item label="备注 :" labelWidth="50px">
								<el-input type="textarea" resize="none" :rows="4" placeholder="请输入备注" v-model="logOut.remarks"></el-input>
							</el-form-item>
						</el-form>
			...
			<div class="collectionDelete readerCard">
				<!-- Form -->
				<el-dialog @close="closeForm('changeForm')" width="400px" :title="Dialogtitle[i]" :visible.sync="changeFormDialog">
...
<script>
	...
	export default {
		...
		methods: {
			...
			filtState(state, cardState, overdue) {
				console.log("???")
				let result = state == 1 ? "失信" : (cardState == 1 ? "挂失" : (overdue == 1 ? "逾期" : "正常"))
				return result
