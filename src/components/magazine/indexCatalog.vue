  ...
  <div id="Notice">
    <el-container>
      <div class="commonMode" style="width:100%;overflow: auto">
        <div class="sonTitle">
          <span class="titleName">期刊编目</span>
        </div>
        <!-- 2.0表单填写 -->
                ...
                <div style="display: flex;flex-direction: column;">
                  <div>
                    <div class="flexLayout" style="width: 840px;">
                      ...
                      >
                        <el-input
                          v-model="addForm.issn"
                          placeholder="请输入ISSN搜索相关数据进行添加"
                          id="isbnInput"
                        >
                          <el-button
                            slot="append"
                      ...
                      <span
                        style="padding-top: 15px;padding-right:60px;font-size: 10px;color: rgb(180, 187, 202)"
                      >若远程或本地都没有相关的数据，请手动录入期刊资料！</span>
                  ...
                  <div id="noError">
                    <div class="flexLayout twoInput">
                      <el-form-item label="期刊名称:" prop="name" style>
                    ...
                    <div id="catalogingInput4" class="flexLayout twoInput">
                      <el-form-item label=" 发行单位 :" prop="fkPressName" class="buttonInput">
                        <div class="flexLayout">
          ...
          <div id="typeMessage">
            <div style="position: relative">
              ...
              <img
                ...
                style="position: absolute;top: 15px;left: 360px;width: 20px;height: 20px"
                @click="closeCheck"
              />
            </div>
      ...
      <div class="forbid collectionDelete">
        <el-dialog
          :title="catalogtitle[j]"
          :visible.sync="centerDialogVisible"
          :width="messageWidth"
          center
        >
          <div v-if="j==0||j==1||j==2">
            <div class="dialogBody" style="margin-left: -30px">是否{{catalogtitle[j]}}?</div>
