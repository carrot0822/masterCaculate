    ...
    <div class="anthoerBox">
      ...
      <section class="tableBox" v-loading="tableLoading">
        ...
        >
          ...
          <el-table-column align="center" prop="name" label="期刊名" :show-overflow-tooltip="true" width="200"></el-table-column>
          <el-table-column align="center" prop="issn" label="ISSN" :show-overflow-tooltip="true" width="200"></el-table-column>
          ...
          <el-table-column align="center" prop="gross" label="总藏馆数量" :show-overflow-tooltip="true" width="150"></el-table-column>
          <el-table-column align="center" prop="inlibrary" label="在馆" :show-overflow-tooltip="true" width="150"></el-table-column>
          ...
          <el-table-column align="center" width="200" prop="eliminateState" label="注销清点" :show-overflow-tooltip="true">
<!--             <template slot-scope="scope">
...
import { damageInt } from "@request/api/magazine/damage";
...
export default {
  ...
  methods: {
    ...
    detailBtn(index, row) {
      ...
      this.$router.push({ path: `/indexCheckDetails/${bookId}` });
    },
    // 分页按钮
    jumpBtn() {
      // v-mode绑定好像会默认转数据类型
